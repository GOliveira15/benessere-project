...
<head>
    ...
    <title>Clínica Benessere | Visão Geral do Médico</title>
</head>
            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Medico/veragendamentos.php">
                                <span data-feather="plus-square"></span>
                                Agendamentos
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../Medico/verpacientes.php">
                                <span data-feather="users"></span>
                                Pacientes
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../Medico/verprescricoes.php">
                                <span data-feather="archive"></span>
                                Prescrições
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../Medico/versolicitacoes.php">
                                <span data-feather="plus-square"></span>
                                Solicitações
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../Medico/verexames.php">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $sql = "SELECT 
                                    (SELECT COUNT(*) FROM consulta_particular WHERE medico_id='$_SESSION[medico_id]') + (SELECT COUNT(*) FROM consulta_plano WHERE medico_id='$_SESSION[medico_id]') AS total_consultas";
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $sql = "SELECT 
                                    (SELECT COUNT(*) FROM prescricao_particular WHERE medico_id='$_SESSION[medico_id]') + (SELECT COUNT(*) FROM prescricao_plano WHERE medico_id='$_SESSION[medico_id]') AS total_prescricoes";
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $sql = "SELECT 
                                    (SELECT COUNT(*) FROM solicitacao_plano WHERE medico_id='$_SESSION[medico_id]') + (SELECT COUNT(*) FROM solicitacao_particular WHERE medico_id='$_SESSION[medico_id]') AS total_solicitacoes";
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card">
                            <img class="card-img-top" src="../../Recursos/pacientes.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Pacientes</h5>
                                <p class="card-text">
                                    Confira os pacientes da semana.
                                </p>
                                <a href="../Medico/veragendamentos.php" class="btn btn-primary">Ver agendamentos</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="../Medico/verexames.php" class="btn btn-primary">Ver exames</a>
                            </div>
                        </div>
                    </div>
                </div>
