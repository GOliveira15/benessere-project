...
<head>
    ...
    <title>Clínica Benessere | Prescrições</title>
</head>
            ...
            <div class="col-md-12 order-md-1">
                <div class="row">
                    <div class="col-md-10 mb-3">
                        <h4 class="mb-3">Prescrição por Plano de Saúde</h4>
                    </div>
                    <div class="col-md-2 mb-3">
                        <a href="../Medico/prescricaoplano.html" class="btn btn-primary btn-lg btn-block">Novo</a>
                    </div>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM prescricao_plano WHERE medico_id='$_SESSION[medico_id]'";
                ...
                <div class="row mt-5">
                    <div class="col-md-10 mb-3">
                        <h4 class="mb-3">Prescrição Particular</h4>
                    </div>
                    <div class="col-md-2 mb-3">
                        <a href="../Medico/prescricaoparticular.html" class="btn btn-primary btn-lg btn-block">Novo</a>
                    </div>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM prescricao_particular WHERE medico_id='$_SESSION[medico_id]'";
                        $rs = mysqli_query($connection, $sql) or die("Erro ao executar a consulta!" . mysqli_error($connection));
                        ...
                        ?>
                            <tr>
                                <th scope="row">
                                    <?= $dados["prescricao_particular_id"] ?>
                                </th>
                                <td>
                                    <?= $dados["paciente_id"] ?>
                                </td>
