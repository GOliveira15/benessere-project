        ...
        <div class="row">
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" novalidate method="post">
                    ...
                    if (isset($_GET['consulta_plano_id']) && is_numeric($_GET['consulta_plano_id'])) {
                        $consulta_plano_id = $_GET['consulta_plano_id'];
                    } else {
                    ...
                    if (isset($_POST["status"])) {
                        ...
                        $sql = "UPDATE consulta_plano SET status='$status' WHERE consulta_plano_id='$consulta_plano_id'";
                ...
                <div class="text-center mt-4">
                    <a href="../Funcionario/veragendamentos.php">Voltar para a página anterior</a>
                </div>
            </div>
        </div>
