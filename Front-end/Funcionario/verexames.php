...
<head>
    ...
    <title>Clínica Benessere | Exames</title>
</head>
            ...
            <div class="col-md-12 order-md-1">
                <div class="row">
                    <div class="col-md-10 mb-3">
                        <h4 class="mb-3">Exame por Plano de Saúde</h4>
                    </div>
                    <div class="col-md-2 mb-3">
                        <a href="../Funcionario/exameplano.php" class="btn btn-primary btn-lg btn-block">Novo</a>
                    </div>
                </div>
                ...
                <div class="row mt-5">
                    <div class="col-md-10 mb-3">
                        <h4 class="mb-3">Exame Particular</h4>
                    </div>
                    <div class="col-md-2 mb-3">
                        <a href="../Funcionario/exameparticular.php" class="btn btn-primary btn-lg btn-block">Novo</a>
                    </div>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM exame_particular";
                        $rs = mysqli_query($connection, $sql) or die("Erro ao executar a consulta!" . mysqli_error($connection));
