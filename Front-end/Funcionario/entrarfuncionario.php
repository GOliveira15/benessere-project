...
<head>
    ...
    <title>Clínica Benessere | Entrar do Funcionário</title>
</head>

<body class="text-center">
    <form action="" method="POST" class="form-signin">
        <img class="mb-4" src="../../Recursos/funcionario.png" alt="" width="72" height="72">
        ...
        if (isset($_POST['email']) && isset($_POST['password'])) {
            ...
            $sql_code = "SELECT * FROM funcionario WHERE email = '$email' AND senha = '$password'";
