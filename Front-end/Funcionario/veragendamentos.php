            ...
            <div class="col-md-12 order-md-1">
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        <a href="../Funcionario/consultaplano.php" class="btn btn-primary btn-lg btn-block">Novo</a>
                    </div>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM consulta_plano";
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                echo "<a href='../Funcionario/gerenciarstatusplano.php?consulta_plano_id=$dados[consulta_plano_id]'>Gerenciar</a>"
                                ?>
                            </td>
                        </tr>
                        <?php
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-2 mb-3">
                        <a href="../Funcionario/consultaparticular.php"
                            class="btn btn-primary btn-lg btn-block">Novo</a>
                    </div>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM consulta_particular";
                        $rs = mysqli_query($connection, $sql) or die("Erro ao executar a consulta!" . mysqli_error($connection));
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                echo "<a href='../Funcionario/gerenciarstatusparticular.php?consulta_particular_id=$dados[consulta_particular_id]'>Gerenciar</a>"
                                ?>
                            </td>
                        </tr>
                        <?php
