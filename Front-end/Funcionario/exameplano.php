...
<head>
    ...
    <title>Clínica Benessere | Exame pelo Plano de Saúde</title>
</head>
...
<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            ...
            <h2>Exame pelo Plano de Saúde</h2>
            <p class="lead">
            ...
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" novalidate method="post" action="">
                    <div class="mb-3">
                        ...
                        <select class="custom-select d-block w-100" name="paciente" id="paciente" required>
                    ...
                    <div class="mb-3">
                        <label for="plano">Plano de Saúde <span class="text-muted">(Obrigatório)</span></label>
                        <select class="custom-select d-block w-100" name="plano" id="plano" required>
                            <option value="">Selecione...</option>
                            <?php
                            // Conexão com o banco de dados
                            $servername = "localhost";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<option value='" . $row['plano_id'] . "'>" . $row['nome_plano'] . "</option>";
                                }
                            } else {
                                echo "0 resultados encontrados";
                            }
                    ...
                    <div class="mb-3">
                        ...
                        <select class="custom-select d-block w-100" name="medico" id="medico" required>
                            <option value="">Selecione...</option>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
                        ...
                        $consulta_plano_id = $_POST["consulta_plano_id"];
                        $solicitacao_plano_id = $_POST["solicitacao_plano_id"];
                        $arquivo = $_POST["arquivo"];

                        error_log("Paciente: " . $paciente_id);
                        error_log("Plano: " . $plano_id);
                        error_log("Médico: " . $medico_id);
                        error_log("Consulta: " . $consulta_plano_id);
                        error_log("Solicitação: " . $solicitacao_plano_id);
                        error_log("Arquivo: " . $arquivo);

                        $sql = "INSERT INTO exame_plano (paciente_id, plano_id, medico_id, consulta_plano_id, solicitacao_plano, arquivo) VALUES ('$paciente_id', '$plano_id' , '$medico_id', '$consulta_plano_id', '$solicitacao_plano_id', '$arquivo')";
