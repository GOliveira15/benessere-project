                    ...
                    <div class="col-md-12 order-md-1">
                        <form class="needs-validation" novalidate method="post" action="">
                            ...
                            if (isset($_POST["paciente_id"], $_POST["medico_id"], $_POST["data_consulta"], $_POST["hora_consulta"])) {
                                ...
                                $sql = "INSERT INTO consulta_particular (paciente_id, medico_id, data_consulta, hora_consulta, valor, status) VALUES ('$paciente_id', '$medico_id' , '$data_consulta', '$hora_consulta', '$valor', '$status')";
