...
<head>
    ...
    <title>Clínica Benessere | Cadastro de Médico</title>
</head>

<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            <img class="d-block mx-auto mb-4" src="../../Recursos/medico.png" alt="" width="72" height="72">
        ...
        <div class="row">
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" novalidate method="post" action="">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="matricula">CRM <span class="text-muted">(Obrigatório)</span></label>
                            <input type="text" class="form-control" name="matricula" id="matricula"
                                placeholder="Informe o CRM" value="" required>
                            <div class="invalid-feedback">
                                É necessário um CRM válido.
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="custom-select d-block w-100" name="especialidade" id="especialidade" required>
                        ...
                        <div class="invalid-feedback">
                            É necessária uma especialidade válida.
                        </div>
                    </div>
                    ...
                    if (isset($_POST["fullname"], $_POST["matricula"], $_POST["cpf"], $_POST["genero"], $_POST["especialidade"], $_POST["email"], $_POST["senha"])) {
                        ...
                        $sql = "INSERT INTO medico (nome_completo, crm, cpf, genero, especialidade, email, senha) VALUES ('$nome_completo', '$crm' , '$cpf', '$genero', '$especialidade', '$email', '$senha')";
                ...
                <div class="text-center mt-4">
                    <a href="../Funcionario/vermedicos.php">Voltar para a página anterior</a>
                </div>
            </div>
        </div>
