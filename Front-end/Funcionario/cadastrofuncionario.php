...
<head>
    ...
    <title>Clínica Benessere | Cadastro de Funcionário</title>
</head>

<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            <img class="d-block mx-auto mb-4" src="../../Recursos/funcionario.png" alt="" width="72" height="72">
        ...
        <div class="row">
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" novalidate method="post" action="">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="matricula">Matrícula <span class="text-muted">(Obrigatório)</span></label>
                            <input type="text" class="form-control" name="matricula" id="matricula"
                                placeholder="Informe a matrícula" value="" required>
                            <div class="invalid-feedback">
                                É necessário uma matrícula válida.
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    if (isset($_POST["fullname"], $_POST["matricula"], $_POST["cpf"], $_POST["genero"], $_POST["email"], $_POST["senha"])) {
                        ...
                        $sql = "INSERT INTO funcionario (nome_completo, matricula, cpf, genero, email, senha) VALUES ('$nome_completo', '$matricula' , '$cpf', '$genero', '$email', '$senha')";
                ...
                <div class="text-center mt-4">
                    <a href="../Funcionario/verfuncionarios.php">Voltar para a página anterior</a>
                </div>
            </div>
        </div>
