...
<head>
    ...
    <title>Clínica Benessere | Entrar do Paciente</title>
</head>

<body class="text-center">
    <form action="" method="POST" class="form-signin">
        <img class="mb-4" src="../../Recursos/paciente.png" alt="" width="72" height="72">
        ...
        <div class="mb-3">
            <label>
                <a href="cadastropaciente.php">Novo? Cadastre-se!</a>
            </label>
        </div>
        ...
        if (isset($_POST['email']) && isset($_POST['password'])) {
            ...
            $sql_code = "SELECT * FROM paciente WHERE email = '$email' AND senha = '$password'";
